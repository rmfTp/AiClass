...
//    }
    ...
    public String memberList(@ModelAttribute @Valid MemberSearch search, Errors errors, Model model){
        ...
        LocalDateTime _sDate = sDate.atStartOfDay();
    ...
    public void view(@PathVariable(name = "seq",required = false) Long mSeq,@PathVariable(name = "email",required = false) String email) {
        if (email==null)System.out.println("seq: "+ mSeq);
        if (mSeq==null)System.out.println("email: "+ email);
